...
public static string Online_Miss_Discard (string Player) => $"Online_Miss_Discard\tPlayer\t{Player}";
...
public static string Online_Avoid_Ability (string Player,string Card) => $"Online_Avoid_Ability\tPlayer\t{Player}\tCard\t{Card}";
