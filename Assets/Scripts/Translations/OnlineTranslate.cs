...
public static string Online_Add_Scout (string Player,string Num) => $"Online_Add_Scout\tPlayer\t{Player}\tNum\t{Num}";
public static string Online_Remove_Scout (string Player,string Num) => $"Online_Remove_Scout\tPlayer\t{Player}\tNum\t{Num}";
